...
export default function ServiceOverlay({ isOpen, onClose, service }: ServiceOverlayProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-custom-offwhite rounded-card max-h-[95vh] overflow-y-auto w-full relative">
        ...
        <div className="flex flex-col p-6 justify-center items-center gap-y-4">
          <TextInput title="Title" value = {service.title} />
          <TextArea title="Description" value = {service.description} />
          <TextInput title="Price (USD)" value = {service.price} />
          <UploadServiceImages initialImages={service.images} />
          <TextInput title="Delivery Time" value = {service.deliveryTime} />
          <CreateForm />
        </div>
